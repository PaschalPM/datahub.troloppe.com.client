  ...
  template: `
    <div
      [class]="
        utils.cn(
          'my-3 border-b',
          { 'border-none dark:bg-white/5 p-1 rounded-lg bg-white shadow-md backdrop-blur-md': type === 'pill' },
          class
        )
      "
    >
...
export class PaneNavigatorPanelComponent {
  ...
  tabClass = 'p-2 px-4 text-black/50 dark:text-white/50 transition-all text-sm ';
  get activeTabClass() {
